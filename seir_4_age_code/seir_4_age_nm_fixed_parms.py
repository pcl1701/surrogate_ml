...
for i in tqdm(range(n_runs)):
    ...
    result = minimize(fun=counted_loss_fn,
                      x0=rng.uniform(low=0.0, high=2.0, size=4),
                      method="Nelder-Mead",
    ...
    # save results
    with open(path + "seir_4_age_nm_n_calls.pkl", "wb") as f:
        pickle.dump(nm_n_calls, f)
    with open(path + "seir_4_age_nm_saved_x.pkl", "wb") as f:
        pickle.dump(nm_saved_x, f)
    with open(path + "seir_4_age_nm_min_nll.pkl", "wb") as f:

...
for i in range(n_runs):
    ...
    # save results
    with open(path + "seir_4_age_rf_n_calls_hyperparms_random.pkl", "wb") as f:
        pickle.dump(rf_n_calls, f)
    with open(path + "seir_4_age_rf_saved_x_hyperparms_random.pkl", "wb") as f:
        pickle.dump(rf_saved_x, f)
    with open(path + "seir_4_age_rf_min_nll_hyperparms_random.pkl", "wb") as f:
        pickle.dump(rf_min_nll, f)
    with open(path + "seir_4_age_rf_n_trees_hyperparms_random.pkl", "wb") as f:
        pickle.dump(rf_n_trees, f)
    with open(path + "seir_4_age_rf_times_hyperparms_random.pkl", "wb") as f:

...
for i in tqdm(range(n_runs)):
    ...
    # save results
    with open(path + "seir_8_age_rf_nm_n_calls.pkl", "wb") as f:
        pickle.dump(rf_nm_n_calls, f)
    with open(path + "seir_8_age_rf_nm_saved_x.pkl", "wb") as f:
        pickle.dump(rf_nm_saved_x, f)
    with open(path + "seir_8_age_rf_nm_min_nll.pkl", "wb") as f:
